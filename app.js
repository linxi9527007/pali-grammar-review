...
async function forceClearAllCaches(){
  try{
    ...
    location.href='./index.html?v=20.29&cache=cleared&ts='+Date.now();
  }catch(e){
...
(function(){
  ...
  window.addEventListener('DOMContentLoaded',function(){document.querySelectorAll('button').forEach(b=>{if(!b.type)b.type='button';});const badge=document.querySelector('.visual-version-badge');if(badge)badge.textContent='Pāli Learning Lab · 20.29 强制版本修正版';updateLessonNav();renderGlobalSearchFull();});
...
(function(){
  ...
  window.addEventListener('DOMContentLoaded',function(){
    ...
    if(badge)badge.textContent='Pāli Learning Lab · 20.29 强制版本修正版';
...
(function(){
  const VERSION_LABEL_184 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_185 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_186 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_187 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_188 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_189 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_190 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_191 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_192 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_193 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_197 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_198 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_199 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_201 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_202 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_2013 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_2014 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_2018 = "Pāli Learning Lab · 20.29 强制版本修正版";
  const DATA_2018 = {
...
(function(){
  const VERSION_LABEL_2019 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_2020 = "Pāli Learning Lab · 20.29 强制版本修正版";
  const INDEX_URL_2020 = "grammar-index.json?v=20.29";
  const MANIFEST_URL_2020 = "grammar-lesson-manifest.json?v=20.29";
  ...
  async function ensureLesson2020(id){
    ...
    lessonPromises2020[id] = manifest2020().then(map => {
      ...
      return fetch(LESSON_BASE_2020 + fname + "?v=20.29", {cache:"no-store"});
    }).then(r => {
...
(function(){
  const VERSION_LABEL_2021 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const VERSION_LABEL_2022 = "Pāli Learning Lab · 20.29 强制版本修正版";
  const MODULE_DIRECTORY_URL_2022 = "grammar-module-directory.json?v=20.29";
  ...
  async function ensureModuleIndex2022(moduleName){
    ...
    modulePromises2022[moduleName] = fetch(MODULE_BASE_2022 + entry.file + "?v=20.29", {cache:"no-store"})
      .then(r => {
...
(function(){
  const VERSION_LABEL_2023 = "Pāli Learning Lab · 20.29 强制版本修正版";
  const EXERCISE_URL_2023 = "exercise-index.json?v=20.29";
...
(function(){
  const VERSION_LABEL_2024 = "Pāli Learning Lab · 20.29 强制版本修正版";
  const SEARCH_URL_2024 = "search-index.json?v=20.29";
...
(function(){
  const VERSION_LABEL_2026 = "Pāli Learning Lab · 20.29 强制版本修正版";
...
(function(){
  const FINAL_LABEL = "Pāli Learning Lab · 20.29 强制版本修正版";
