...
(function(){
  ...
  window.addEventListener('DOMContentLoaded',function(){document.querySelectorAll('button').forEach(b=>{if(!b.type)b.type='button';});const badge=document.querySelector('.visual-version-badge');if(badge)badge.textContent='Pāli Learning Lab · 15.0 课程说明清爽版';updateLessonNav();renderGlobalSearchFull();});
...
(function(){
  ...
  window.addEventListener('DOMContentLoaded',function(){
    ...
    if(badge)badge.textContent='Pāli Learning Lab · 15.0 课程说明清爽版';
