...
async function init(){
  GRAMMAR=await (await fetch('grammar.json')).json();
...
init().catch(e=>alert('加载失败：请确认 13 个网站文件都已上传。'));
